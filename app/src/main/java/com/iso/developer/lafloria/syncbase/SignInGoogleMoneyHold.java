...
public class SignInGoogleMoneyHold {
    ...
    public SignInGoogleMoneyHold(Context con,UpdateSucsess succsesEventik){
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(context)
                .enableAutoManage((FloriaActivity)context /* FragmentActivity */, conFaild /* OnConnectionFailedListener */)
    ...
    public void regitUser(){
        if(!SyncBase.isNetworkAvailable(context)){
            ...
            builder.setMessage(context.getString(R.string.connection_failed))
        ...
        ((FloriaActivity)context).startActivityForResult(signInIntent, RC_SIGN_IN);
    ...
    public void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(((FloriaActivity)context ), new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    public void showProgressDialog() {
        if (mProgressDialog == null) {
            ...
            mProgressDialog.setMessage(context.getString(R.string.loadingf));
    ...
    public void openDialog() {
        ...
        final View dialogView = ((FloriaActivity) context).getLayoutInflater().inflate(R.layout.first_login_info, null);
